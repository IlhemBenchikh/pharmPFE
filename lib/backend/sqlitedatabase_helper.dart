...
class DatabaseHelper {
  ...
  static openDB() async {
    _db = await openDatabase("pahrmE.db", version: 1,
  ...
  static Future<List<Map<String, dynamic>>> getReliquatList() async {
    return _db.query(
      "drug",
      where: "drug_stability = 0",
    );
  }
